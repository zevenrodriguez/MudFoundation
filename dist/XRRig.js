// AUTO-GENERATED from XRRig.js by build.py — edit the source, then rebuild.
//
//   #pragma import(XRRig = "<url to this file>")
//   const lib = XRRig({ THREE, scene, camera, Input, avatarRig, avatarPOV });
(function (root, factory) {
    if (typeof module === 'object' && module.exports) module.exports = factory();
    else if (typeof define === 'function' && define.amd) define([], factory);
    else root.XRRig = factory();
}(typeof globalThis !== 'undefined' ? globalThis : this, function () {
    return function XRRig(mud) {
        const { THREE, scene, camera, Input, avatarRig, avatarPOV } = mud || {};
        ...
        return { makeRayLine: makeRayLine, updateRayLine: updateRayLine, startup: startup, update: update, dispose: dispose };
    };
}));
