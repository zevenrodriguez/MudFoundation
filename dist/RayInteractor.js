// AUTO-GENERATED from RayInteractor.js by build.py — edit the source, then rebuild.
//
//   #pragma import(RayInteractor = "<url to this file>")
//   const lib = RayInteractor({  });
(function (root, factory) {
    if (typeof module === 'object' && module.exports) module.exports = factory();
    else if (typeof define === 'function' && define.amd) define([], factory);
    else root.RayInteractor = factory();
}(typeof globalThis !== 'undefined' ? globalThis : this, function () {
    return function RayInteractor(mud) {
        const {  } = mud || {};
        ...
        return { RayInteractor: RayInteractor };
    };
}));
