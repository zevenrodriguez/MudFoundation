...
/*
 * XRRig — the player's XR presence: owns starting/stopping XR input,
 * draws the per-hand laser-pointer ray lines, and moves the avatar with
 * the left controller's thumbstick.
 *
 * Raycast.js reads controller poses from Input.xr for hit-testing/clicks
 * (cube, sphere, button, ...), but does not start or stop XR input itself —
 * this rig is the one script responsible for that lifecycle.
 */
